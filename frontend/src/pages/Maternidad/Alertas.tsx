// src/pages/Maternidad/Alertas.tsx
...
import {
  ...
  deleteAlerta,
  AlertaMaternidad,
} from "../../services/maternidad/Alertas";
const tipoOptions = [
  "Sanitaria",
  "Nutricional",
  "Reproductiva",
...
const emptyForm: Omit<AlertaMaternidad, "id"> = {
  fecha: "",
  tipo: "Sanitaria",
  nivel: "Crítico",
  descripcion: "",
...
export default function MaternidadAlertas() {
  const [alertas, setAlertas] = useState<AlertaMaternidad[]>([]);
  const [form, setForm] = useState<Omit<AlertaMaternidad, "id">>(emptyForm);
  ...
  return (
    <Card sx={{ mb: 3, maxWidth: 1050, margin: "0 auto" }}>
      <CardContent>
        ...
        >
          <DialogTitle>
            {editId ? "Editar Alerta" : "Registrar Alerta"}
          </DialogTitle>
          <DialogContent
            sx={{
              display: "flex",
            ...
            >
              ...
              <TextField
                ...
                onChange={(e) =>
                  setForm((f) => ({
                    ...f,
                    tipo: e.target.value as AlertaMaternidad["tipo"],
                  }))
                }
              >
                {tipoOptions.map((op) => (
              ...
              <TextField
                ...
                onChange={(e) =>
                  setForm((f) => ({
                    ...f,
                    nivel: e.target.value as AlertaMaternidad["nivel"],
                  }))
                }
              >
                {nivelOptions.map((op) => (
              ...
              <TextField
                ...
                onChange={(e) =>
                  setForm((f) => ({
                    ...f,
                    estado: e.target.value as AlertaMaternidad["estado"],
                  }))
                }
              >
